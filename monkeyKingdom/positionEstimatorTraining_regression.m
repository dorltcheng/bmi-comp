...
function [modelParameters, firingRates, velocities] = positionEstimatorTraining_regression(training_data)
...
%% Linear Regression training
    ...
    function x = least_squares_minnorm(A, b)
        ...
        rank_A = sum(S(:) > max(size(A)) * eps(S(1))); % rank for small singular values
